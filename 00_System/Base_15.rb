    ...
    unless $game_party.in_partybattle? or $msg.t_enemy.love > 0
      ...
      if $msg.t_target == $game_actors[101]
        ...
        if $msg.t_partner != nil
          ...
          @partner = "Young missie" if $msg.age2 > 0 #年下仲間への二人称
          @partner = "Babe" if $msg.age2 < 0 #年上仲間への二人称
          @partner = "Girl" if @doppel_pt #同属仲間への二人称
        end
      #▼会話対象が主人公でない場合
      elsif $msg.t_target != $game_actors[101]
        @target = "Girl" #仲間への二人称
        @target = "Young missie" if $msg.age > 0 #年下仲間への二人称
        @target = "Babe" if $msg.age < 0 #年上仲間への二人称
      ...
      if $game_switches[97] == true
        ...
        if $msg.coop_leader != $msg.t_enemy
          ...
          @cp_leader = "Young missie" if $msg.age3 > 0 #年下相方への二人称
          @cp_leader = "Babe" if $msg.age3 < 0 #年上相方への二人称
      ...
      if $game_switches[97] == true
        ...
        if $msg.coop_leader != $msg.t_enemy
          if @companion_cp == true
            ...
            @cp_leader = "Girl" #相方への二人称
            @cp_leader = "Young missie" if $msg.age3 > 0 #年下仲間への二人称
            @cp_leader = "Babe" if $msg.age3 < 0 #年上仲間への二人称
