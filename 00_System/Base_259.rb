    ...
    unless $game_party.in_partybattle? or $msg.t_enemy.love > 0
      ...
      if $msg.t_target == $game_actors[101]
        ...
        if $msg.t_partner != nil
          ...
          @partner = "君" if $msg.age2 < 0 #年上仲間への二人称
          @partner = "君" if $msg.t_partner.boss_graphic? #相手がユニークキャラクター
        end
      #▼会話対象が主人公でない場合
      elsif $msg.t_target != $game_actors[101]
        @target = "君" #仲間への二人称
        @target = "君" if $msg.age > 0 #年下仲間への二人称
        @target = "君" if $msg.age < 0 #年上仲間への二人称
        @target = "君" if $msg.t_target.boss_graphic? #相手がユニークキャラクター
        @partner = "君"
      end
      ...
      if $game_switches[97] == true
        ...
        if $msg.coop_leader != $msg.t_enemy
          ...
          @cp_leader = "君" if $msg.age3 < 0 #年上相方への二人称
          @cp_leader = "君" if $msg.coop_leader.boss_graphic? #連携相手がユニークキャラクター
        end
      end
    #=====================================================================
      ...
      if $game_switches[97] == true
        ...
        if $msg.coop_leader != $msg.t_enemy
          if @companion_cp == true
            ...
            @cp_leader = "君" if $msg.age3 < 0 #年上仲間への二人称
            @cp_leader = "君" if $msg.coop_leader.boss_graphic? #連携相手がユニークキャラクター
          end
        end
      end
