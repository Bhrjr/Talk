    ...
    unless $game_party.in_partybattle? or $msg.t_enemy.love > 0
      ...
      if $msg.t_target == $game_actors[101]
        ...
        if $msg.t_partner != nil
          ...
          @partner = "Li'l sissy" if $msg.age2 > 0 #年下仲間への二人称
      ...
      #▼会話対象が主人公でない場合
        ...
        @target = "Li'l sissy" if $msg.age > 0 #年下仲間への二人称
      ...
      if $game_switches[97] == true
        ...
        if $msg.coop_leader != $msg.t_enemy
          ...
          @cp_leader = "Li'l sissy" if $msg.age3 > 0 #年下相方への二人称
    ...
    #★対味方戦の場合、パートナー夢魔の呼称のみを決める
      ...
      if $msg.t_target == $game_actors[101]
        ...
        if $msg.t_partner != nil
          if @companion_pt == true#相手の事を知っている場合の二人称
            ...
            @partner = "Li'l sis #{$msg.short_name($msg.t_partner)}" if $msg.age2 > 0 #年下仲間への二人称
      ...
      #▼会話対象が主人公でない場合
        ...
        if @companion == true#相手の事を知っている場合の二人称
          ...
          @target = "Li'l sis #{$msg.short_name($msg.t_target)}" if $msg.age > 0 #年下仲間への二人称
      ...
      if $game_switches[97] == true
        ...
        if $msg.coop_leader != $msg.t_enemy
          if @companion_cp == true
            ...
            @cp_leader = "Li'l sis #{$msg.short_name($msg.coop_leader)}" if $msg.age3 > 0 #年下相方への二人称
            ...
            @cp_leader = "Sissy" #相方への二人称
            @cp_leader = "Li'l sissy" if $msg.age3 > 0 #年下仲間への二人称
